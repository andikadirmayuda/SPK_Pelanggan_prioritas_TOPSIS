                    ...
                    <form method="POST" action="{{ route('sub-kriteria.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="nilai" name="nilai" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required onchange="updateKeterangan(this.value)">
                                ...
                                @foreach ($nilaiOptions as $nilai => $keterangan)
                        ...
                        <div>
                            ...
                            <x-text-input id="keterangan" name="keterangan" type="text" class="mt-1 block w-full bg-gray-100" readonly :value="old('keterangan')" required />
