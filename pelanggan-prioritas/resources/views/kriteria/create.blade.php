                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('kriteria.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" id="nama" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required value="{{ old('nama') }}">
                            @error('nama')
                        ...
                        <div class="mb-4">
                            <label for="bobot" class="block text-sm font-medium text-gray-700">
                                ...
                                <span class="text-sm text-gray-500">
                                    - Sisa bobot yang tersedia: {{ number_format($sisaBobot, 2) }}
                                </span>
                            </label>
                            <input type="number" step="0.01" min="0" max="{{ $sisaBobot }}" name="bobot" id="bobot" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required value="{{ old('bobot') }}">
                            @error('bobot')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
